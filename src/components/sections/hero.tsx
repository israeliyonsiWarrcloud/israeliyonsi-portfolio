...
export function Hero() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center mesh-gradient relative overflow-hidden">
      <div className="max-w-6xl mx-auto w-full section-padding pt-20 lg:pt-16">
